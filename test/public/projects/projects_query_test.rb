...
module Projects
  class ProjectsQueryTest < ActiveSupport::TestCase
    ...
    test '.perform returns no projects with invalid year' do
      result = Projects::ProjectsQuery.new(department: 'electrical', year: 'not a valid year', page: nil,
                                           name: nil).perform
    ...
    test '.perform returns no projects with invalid department and invalid year' do
      result = Projects::ProjectsQuery.new(department: 'invalid department', year: 'invalid year', page: nil,
                                           name: nil).perform
